...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_MATRICULATION_DESC;
import static seedu.address.logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static seedu.address.logic.commands.CommandTestUtil.INVALID_TAG_DESC;
import static seedu.address.logic.commands.CommandTestUtil.MATRICULATION_DESC_AMY;
import static seedu.address.logic.commands.CommandTestUtil.MATRICULATION_DESC_BOB;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_MATRICULATION_DESC, Matriculation.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + INVALID_EMAIL_DESC, Email.MESSAGE_CONSTRAINTS); // invalid email
        assertParseFailure(parser, "1" + INVALID_TAG_DESC, Tag.MESSAGE_CONSTRAINTS); // invalid tag

        // invalid phone followed by valid email
        assertParseFailure(parser, "1" + INVALID_MATRICULATION_DESC + EMAIL_DESC_AMY,
        ...
        assertParseFailure(parser, "1" + MATRICULATION_DESC_BOB + INVALID_MATRICULATION_DESC,
                Matriculation.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_MATRICULATION_AMY,
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withMatriculation(VALID_MATRICULATION_BOB)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditPersonDescriptorBuilder().withMatriculation(VALID_MATRICULATION_AMY).build();
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        descriptor = new EditPersonDescriptorBuilder().withMatriculation(VALID_MATRICULATION_BOB)
