...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(null, VALID_MATRICULATION, VALID_EMAIL, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(VALID_NAME, VALID_MATRICULATION, null, VALID_TAGS);
