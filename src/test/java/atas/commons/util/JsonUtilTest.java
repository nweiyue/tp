...
import static atas.commons.util.FileUtil.writeToFile;
...
import atas.testutil.SerializableTestClass;
import atas.testutil.TestUtil;
...
public class JsonUtilTest {
    ...
    public void deserializeObjectFromJsonFile_noExceptionThrown() throws IOException {
        writeToFile(SERIALIZATION_FILE, SerializableTestClass.JSON_STRING_REPRESENTATION);
