...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the details of the person identified "
            ...
            + "[" + PREFIX_NAME + "NAME] "
            + "[" + PREFIX_MATRICULATION + "PHONE] "
            + "[" + PREFIX_EMAIL + "EMAIL] "
            + "[" + PREFIX_TAG + "TAG]...\n"
            + "Example: " + COMMAND_WORD + " 1 "
            + PREFIX_MATRICULATION + "A7654321X "
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        Matriculation updatedMatriculation = editPersonDescriptor.getMatriculation().orElse(personToEdit.getMatriculation());
        Email updatedEmail = editPersonDescriptor.getEmail().orElse(personToEdit.getEmail());
        Set<Tag> updatedTags = editPersonDescriptor.getTags().orElse(personToEdit.getTags());

        return new Person(updatedName, updatedMatriculation, updatedEmail, updatedTags);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, matriculation, email, tags);
        }
