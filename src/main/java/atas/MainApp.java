...
import static atas.commons.util.ConfigUtil.readConfig;
import static atas.commons.util.ConfigUtil.saveConfig;
...
import atas.commons.core.Config;
import atas.commons.core.LogsCenter;
import atas.commons.core.Version;
...
public class MainApp extends Application {
    ...
    protected Config initConfig(Path configFilePath) {
        ...
        try {
            Optional<Config> configOptional = readConfig(configFilePathUsed);
        ...
        try {
            saveConfig(initializedConfig, configFilePathUsed);
        } catch (IOException e) {
